...
from lib import change_coord, euler, quat, quat_1, quat_multi, delta_quat, Log
...
def test_pelvis_torso():
    ...
    q_new = quat_multi(delta, quat_multi(q_old, quat_1(delta)))
    Log.debug(f"{locals()=}")
